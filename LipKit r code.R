...
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\LipKit_final.xlsx")
...
# Load the data from the Excel file
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\LipKit_final.xlsx")  # Corrected path
...
plot(predict_topics, covariate = "Website", topics = c(1, 4, 10),
     ...
     cov.value1 = "influenster", cov.value2 = "Kylie cosmetics",  # Corrected website names
     xlab = "More Kylie cosmetics ... More influenster",  # Adjusted label
     main = "Effect of influenster vs. Kylie cosmetics",
