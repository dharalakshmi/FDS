...
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\Foaming facewash_final.xlsx")
...
# Load the data from the Excel file
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\Foaming facewash_final.xlsx")  # Corrected path
...
plot(predict_topics, covariate = "Website", topics = c(1, 4, 10),
     ...
     cov.value1 = "amazon", cov.value2 = "kyliecosmetics",  # Corrected website names
     xlab = "More kyliecosmetics ... More amazon",  # Adjusted label
     main = "Effect of amazon vs. kyliecosmetics",
