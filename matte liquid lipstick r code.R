...
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\matte liquid lipstick_final.xlsx")
...
# Load the data from the Excel file
news <- read_excel("C:\\Users\\dhara\\Downloads\\FDS\\matte liquid lipstick_final.xlsx")  # Corrected path
...
set.seed(837)
cloud(Third_STM, topic=17, scale=c(2,1))
...
plot(predict_topics, covariate = "Website", topics = c(1, 4, 10),
     ...
     cov.value1 = "amazon", cov.value2 = "kylie cosmetics",  # Corrected website names
     xlab = "More kylie cosmetics ... More amazon",  # Adjusted label
     main = "Effect of amazon vs. kylie cosmetics",
